...
class Subplot(object):
    ...
    def addCallback(self, label, callback, defaultClass=LineMarker):
        ...
        :type label: string.
        :param callback: A function that receives a :class:`engine.bar.Bars` instance as a parameter and returns a number or None.
        """
        self.__callbacks[callback] = self.getSeries(label, defaultClass)
...
class StrategyPlotter(object):
    ...
    :type strat: :class:`engine.strategy.BaseStrategy`.
