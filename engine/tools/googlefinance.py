...
from engine.barfeed import googlefeed
from engine.utils import csvutils
...
def build_feed(instruments, fromYear, toYear, storage, frequency=bar.Frequency.DAY, timezone=None, skipErrors=False):
    """Build and load a :class:`engine.barfeed.googlefeed.Feed` using CSV files downloaded from Google Finance.
    ...
    :rtype: :class:`engine.barfeed.googlefeed.Feed`.
    """

    logger = engine.logger.getLogger("googlefinance")
