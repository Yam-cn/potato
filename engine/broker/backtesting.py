...
from engine.broker import fillstrategy
...
class Broker(broker.Broker):
    ...
    def setFillStrategy(self, strategy):
        """Sets the :class:`engine.broker.fillstrategy.FillStrategy` to use."""
        self.__fillStrategy = strategy

    def getFillStrategy(self):
        """Returns the :class:`engine.broker.fillstrategy.FillStrategy` currently set."""
