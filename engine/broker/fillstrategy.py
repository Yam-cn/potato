...
class FillStrategy(object):
    ...
    def fillMarketOrder(self, broker_, order, bar):
        ...
        :type order: :class:`engine.broker.MarketOrder`
        :param bar: The current bar.
        :type bar: :class:`engine.bar.Bar`
    ...
    def fillLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`engine.broker.LimitOrder`
        :param bar: The current bar.
        :type bar: :class:`engine.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`engine.broker.StopOrder`
        :param bar: The current bar.
        :type bar: :class:`engine.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
    ...
    def fillStopLimitOrder(self, broker_, order, bar):
        ...
        :type broker_: :class:`Broker`
        :param order: The order.
        :type order: :class:`engine.broker.StopLimitOrder`
        :param bar: The current bar.
        :type bar: :class:`engine.bar.Bar`
        :rtype: A :class:`FillInfo` or None if the order should not be filled.
        """
...
class DefaultStrategy(FillStrategy):
    ...
    * A :class:`engine.broker.MarketOrder` is always filled using the open/close price.
    * A :class:`engine.broker.LimitOrder` will be filled like this:
    ...
    * A :class:`engine.broker.StopOrder` will be filled like this:
    ...
    * A :class:`engine.broker.StopLimitOrder` will be filled like this:
    ...
    .. note::
        ...
        * It uses :class:`engine.broker.slippage.NoSlippage` slippage model by default.
    ...
    def onBars(self, broker_, bars):
        ...
        for instrument in bars.getInstruments():
            ...
            if bar.getFrequency() == engine.bar.Frequency.TRADE:
    ...
    def setSlippageModel(self, slippageModel):
        ...
        :type slippageModel: :class:`engine.broker.slippage.SlippageModel`
        """
