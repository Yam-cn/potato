...
from engine.feed import memfeed
...
class Feed(BaseFeed):
    ...
    :param timezone: The timezone to use to localize datetimes. Check :mod:`engine.marketsession`.
    :type timezone: A pytz timezone.
    :param maxLen: The maximum number of values that each :class:`engine.dataseries.DataSeries` will hold.
