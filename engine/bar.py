...
class Bars(object):
    ...
    def __getitem__(self, instrument):
        """Returns the :class:`engine.bar.Bar` for the given instrument.
        If the instrument is not found an exception is raised."""
        return self.__barDict[instrument]

    def __contains__(self, instrument):
        """Returns True if a :class:`engine.bar.Bar` for the given instrument is available."""
    ...
    def getBar(self, instrument):
        """Returns the :class:`engine.bar.Bar` for the given instrument or None if the instrument is not found."""
