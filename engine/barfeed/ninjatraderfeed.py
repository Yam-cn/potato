...
from engine.barfeed import csvfeed
...
class Frequency(object):
    MINUTE = engine.bar.Frequency.MINUTE
    DAILY = engine.bar.Frequency.DAY
...
class Feed(csvfeed.BarFeed):
    """A :class:`engine.barfeed.csvfeed.BarFeed` that loads bars from CSV files exported from NinjaTrader.

    :param frequency: The frequency of the bars. Only **engine.bar.Frequency.MINUTE** or **engine.bar.Frequency.DAY**
        are supported.
    ...
    def addBarsFromCSV(self, instrument, path, timezone=None):
        ...
        :type path: string.
        :param timezone: The timezone to use to localize bars. Check :mod:`engine.marketsession`.
        :type timezone: A pytz timezone.
        """
