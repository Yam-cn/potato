...
from engine.barfeed import common
...
class Feed(csvfeed.BarFeed):
    """A :class:`engine.barfeed.csvfeed.BarFeed` that loads bars from CSV files downloaded from Google Finance.

    :param frequency: The frequency of the bars. Only **engine.bar.Frequency.DAY** is currently supported.
