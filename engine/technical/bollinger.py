...
from engine.technical import stats
...
class BollingerBands(object):
    ...
    :type dataSeries: :class:`engine.dataseries.DataSeries`.
    ...
    def getUpperBand(self):
        """
        Returns the upper band as a :class:`engine.dataseries.DataSeries`.
        """
        return self.__upperBand

    def getMiddleBand(self):
        """
        Returns the middle band as a :class:`engine.dataseries.DataSeries`.
        """
        return self.__sma

    def getLowerBand(self):
        """
        Returns the lower band as a :class:`engine.dataseries.DataSeries`.
        """
