...
class MACD(dataseries.SequenceDataSeries):
    ...
    def getSignal(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the EMA over the MACD."""
        return self.__signal

    def getHistogram(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the histogram (the difference between the MACD and the Signal)."""
