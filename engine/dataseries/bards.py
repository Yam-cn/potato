...
class BarDataSeries(dataseries.SequenceDataSeries):
    """A DataSeries of :class:`engine.bar.Bar` instances.
    ...
    def getOpenDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the open prices."""
        return self.__openDS

    def getCloseDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the close prices."""
        return self.__closeDS

    def getHighDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the high prices."""
        return self.__highDS

    def getLowDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the low prices."""
        return self.__lowDS

    def getVolumeDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the volume."""
        return self.__volumeDS

    def getAdjCloseDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the adjusted close prices."""
        return self.__adjCloseDS

    def getPriceDataSeries(self):
        """Returns a :class:`engine.dataseries.DataSeries` with the close or adjusted close prices."""
    ...
    def getExtraDataSeries(self, name):
        """Returns a :class:`engine.dataseries.DataSeries` for an extra column."""
